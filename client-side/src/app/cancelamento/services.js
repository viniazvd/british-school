...
export const totalPagesCancelamento = () => {
	...
	return http.post('http://localhost:3000/api/cancelamento-total-pages', { ver_todas_contas }).then(res => res.data)
}
...
export const cancelamento = (page) => {
	...
	return http.post('http://localhost:3000/api/cancelamento?page='+page, { ver_todas_contas }).then(res => res.data)
}
